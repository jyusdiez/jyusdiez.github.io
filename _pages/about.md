...
<div class="container" style="margin-top: 3rem; margin-left: 10rem; margin-bottom: 3rem;">
  ...
  <!-- Profile picture -->
  <img src="{{ site.baseurl }}/images/profile_v3.JPG" alt="{{ site.author.name }}" class="avatar" style="height: 150px; width: auto;"> <!--style="width:25vw; max-width:150px; height:auto; border-radius:50%; margin-bottom:1rem;">,-->
